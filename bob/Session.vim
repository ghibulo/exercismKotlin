...
silent only
cd /home/secondSystem/home/ghibulo/exercism/kotlin/bob
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Bob.kts
badd +0 src/test/kotlin/BobTest.kt
argglobal
silent! argdel *
$argadd Bob.kts
set stal=2
...
13
normal! 017|
tabedit src/test/kotlin/BobTest.kt
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 118 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
