...
silent only
cd ~/exercism/kotlin/phone-number
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/test/kotlin/PhoneNumberTest.kt
badd +0 PhoneNumber.kts
argglobal
silent! argdel *
$argadd src/test/kotlin/PhoneNumberTest.kt
set stal=2
edit src/test/kotlin/PhoneNumberTest.kt
...
silent! normal! zE
let s:l = 26 - ((16 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
normal! 040|
tabedit PhoneNumber.kts
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
