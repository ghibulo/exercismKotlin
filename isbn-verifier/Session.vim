...
silent only
cd ~/exercism2/kotlin/isbn-verifier
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/test/kotlin/IsbnVerifierTest.kt
badd +0 IsbnVerifier.kts
argglobal
silent! argdel *
$argadd src/test/kotlin/IsbnVerifierTest.kt
set stal=2
edit src/test/kotlin/IsbnVerifierTest.kt
