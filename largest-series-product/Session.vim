...
silent only
cd ~/exercism/kotlin/largest-series-product
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/test/kotlin/SeriesTest.kt
badd +1 Series.kts
argglobal
silent! argdel *
$argadd src/test/kotlin/SeriesTest.kt
set stal=2
edit src/test/kotlin/SeriesTest.kt
...
silent! normal! zE
let s:l = 73 - ((21 * winheight(0) + 16) / 32)
