...
silent only
cd ~/exercism2/kotlin/nucleotide-count
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/test/kotlin/DnaTest.kt
badd +1 Dna.kts
argglobal
silent! argdel *
$argadd src/test/kotlin/DnaTest.kt
set stal=2
edit src/test/kotlin/DnaTest.kt
...
silent! normal! zE
let s:l = 45 - ((30 * winheight(0) + 17) / 34)
